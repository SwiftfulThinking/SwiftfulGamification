...
struct MockRemoteExperiencePointsServiceTests {
    ...
    func testInitializesWithProvidedData() async throws {
        // Given: XP data
        let data = CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 5000)
        ...
        let stream = service.streamCurrentExperiencePoints(userId: "user1", experienceId: "test")
    ...
    func testInitializesWithEmptyEvents() async throws {
        // Given: Service
        let service = MockRemoteExperiencePointsService(data: CurrentExperiencePointsData.blank(experienceId: "test"))

        // When: Getting all events
        let events = try await service.getAllEvents(userId: "user1", experienceId: "test")
    ...
    func testUpdateCurrentExperiencePointsPersists() async throws {
        ...
        let initial = CurrentExperiencePointsData.blank(experienceId: "test")
        let service = MockRemoteExperiencePointsService(data: initial)

        // When: Updating data
        let newData = CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 10000)
        try await service.updateCurrentExperiencePoints(userId: "user1", experienceId: "test", data: newData)
    ...
    func testUpdateCurrentExperiencePointsTriggersStream() async throws {
        ...
        let initial = CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 5000)
        let service = MockRemoteExperiencePointsService(data: initial)
        ...
        // When: Updating data
        let newData = CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 15000)
        try await service.updateCurrentExperiencePoints(userId: "user1", experienceId: "test", data: newData)
    ...
    func testStreamEmitsInitialValue() async throws {
        ...
        let data = CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 7000)
        let service = MockRemoteExperiencePointsService(data: data)
    ...
    func testStreamEmitsUpdates() async throws {
        // Given: Service
        let initial = CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 3000)
        let service = MockRemoteExperiencePointsService(data: initial)
        ...
        // When: Updating data
        try await service.updateCurrentExperiencePoints(userId: "user1", experienceId: "test", data: CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 8000))
    ...
    func testStreamMultipleListeners() async throws {
        ...
        let stream1 = service.streamCurrentExperiencePoints(userId: "user1", experienceId: "test")
        let stream2 = service.streamCurrentExperiencePoints(userId: "user1", experienceId: "test")
    ...
    func testStreamCleansUpOnCancellation() async throws {
        ...
        let service = MockRemoteExperiencePointsService(data: CurrentExperiencePointsData.mock(experienceId: "test"))
    ...
    func testAddEventAddsToArray() async throws {
        ...
        // When: Adding event
        let event = ExperiencePointsEvent.mock(experienceId: "test")
        try await service.addEvent(userId: "user1", experienceId: "test", event: event)
    ...
    func testAddEventDoesNotModifyExisting() async throws {
        ...
        let service = MockRemoteExperiencePointsService(data: CurrentExperiencePointsData.blank(experienceId: "test"))
        let event1 = ExperiencePointsEvent.mock(id: "event-1", experienceId: "test")
        try await service.addEvent(userId: "user1", experienceId: "test", event: event1)

        // When: Adding another event
        let event2 = ExperiencePointsEvent.mock(id: "event-2", experienceId: "test")
        try await service.addEvent(userId: "user1", experienceId: "test", event: event2)
    ...
    func testGetAllEventsReturnsAll() async throws {
        ...
        let events = [
            ExperiencePointsEvent.mock(id: "1", experienceId: "test"),
            ExperiencePointsEvent.mock(id: "2", experienceId: "test"),
            ExperiencePointsEvent.mock(id: "3", experienceId: "test")
        ]
        ...
        // When: Getting all events
        let retrieved = try await service.getAllEvents(userId: "user1", experienceId: "test")
    ...
    func testDeleteAllEventsClearsArray() async throws {
        ...
        let service = MockRemoteExperiencePointsService(data: CurrentExperiencePointsData.blank(experienceId: "test"))
        try await service.addEvent(userId: "user1", experienceId: "test", event: ExperiencePointsEvent.mock(experienceId: "test"))
        try await service.addEvent(userId: "user1", experienceId: "test", event: ExperiencePointsEvent.mock(experienceId: "test"))

        // When: Deleting all events
        try await service.deleteAllEvents(userId: "user1", experienceId: "test")
    ...
    func testCalculateExperiencePointsIsNoOp() async throws {
        ...
        try await service.calculateExperiencePoints(userId: "user1", experienceId: "test")
    ...
    func testMultipleUpdatesPreserveIntegrity() async throws {
        ...
        try await service.addEvent(userId: "user1", experienceId: "test", event: ExperiencePointsEvent.mock(id: "e1", experienceId: "test"))
        try await service.updateCurrentExperiencePoints(userId: "user1", experienceId: "test", data: CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 1000))

        try await service.addEvent(userId: "user1", experienceId: "test", event: ExperiencePointsEvent.mock(id: "e2", experienceId: "test"))
        try await service.updateCurrentExperiencePoints(userId: "user1", experienceId: "test", data: CurrentExperiencePointsData.mock(experienceId: "test", totalPoints: 2000))
